...
[![typecheck, build, distribution](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/quality.yml?branch=main&label=typecheck%2C%20build%2C%20distribution)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/quality.yml)
[![client, schemas, transports, normalizers, sessions, venues, WAF](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/unit-tests.yml?branch=main&label=client%2C%20schemas%2C%20transports%2C%20normalizers%2C%20sessions%2C%20venues%2C%20WAF)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/unit-tests.yml)

**Scheduled live tests**

[![sessions, account, assets, derivatives, candles, orders, portfolio, timeline, documents, taxes, payments](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/general-read-only-validation.yml?branch=main&event=schedule&label=sessions%2C%20account%2C%20assets%2C%20derivatives%2C%20candles%2C%20orders%2C%20portfolio%2C%20timeline%2C%20documents%2C%20taxes%2C%20payments)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/general-read-only-validation.yml)
[![stocks, ETFs, funds, mutual funds, private funds, derivatives, crypto, bonds, synthetics](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-order-destinations-during-closed-market-hours.yml?branch=main&event=schedule&label=stocks%2C%20ETFs%2C%20funds%2C%20mutual%20funds%2C%20private%20funds%2C%20derivatives%2C%20crypto%2C%20bonds%2C%20synthetics)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-order-destinations-during-closed-market-hours.yml)
[![quotations, price-for-order, market subscriptions, last trades/tape, ticker, L2 books, order destinations](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-venue-during-opening-times.yml?branch=main&event=schedule&label=quotations%2C%20price-for-order%2C%20market%20subscriptions%2C%20last%20trades%2Ftape%2C%20ticker%2C%20L2%20books%2C%20order%20destinations)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-venue-during-opening-times.yml)
[![watchlists, price alerts](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-reversible-account-mutations.yml?branch=main&event=schedule&label=watchlists%2C%20price%20alerts)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-reversible-account-mutations.yml)
[![EUR 1 limit buy, exchangeClosed response](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-closed-venue-limit-order-rejection.yml?branch=main&event=schedule&label=EUR%201%20limit%20buy%2C%20exchangeClosed%20response)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-closed-venue-limit-order-rejection.yml)
[![EUR 1 market buy, exchangeClosed response](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-closed-venue-market-order-rejection.yml?branch=main&event=schedule&label=EUR%201%20market%20buy%2C%20exchangeClosed%20response)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-closed-venue-market-order-rejection.yml)
[![order updates, EUR 1 submit, EUR 0.50 replace, cancel, cleanup](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-open-venue-limit-order-lifecycle.yml?branch=main&event=schedule&label=order%20updates%2C%20EUR%201%20submit%2C%20EUR%200.50%20replace%2C%20cancel%2C%20cleanup)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-open-venue-limit-order-lifecycle.yml)

**Manually triggered live tests**

[![sessions, account, assets, derivatives, candles, orders, portfolio, timeline, documents, taxes, payments](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/general-read-only-validation.yml?branch=main&event=workflow_dispatch&label=sessions%2C%20account%2C%20assets%2C%20derivatives%2C%20candles%2C%20orders%2C%20portfolio%2C%20timeline%2C%20documents%2C%20taxes%2C%20payments)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/general-read-only-validation.yml)
[![stocks, ETFs, funds, mutual funds, private funds, derivatives, crypto, bonds, synthetics](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-order-destinations-during-closed-market-hours.yml?branch=main&event=workflow_dispatch&label=stocks%2C%20ETFs%2C%20funds%2C%20mutual%20funds%2C%20private%20funds%2C%20derivatives%2C%20crypto%2C%20bonds%2C%20synthetics)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-order-destinations-during-closed-market-hours.yml)
[![quotations, price-for-order, market subscriptions, last trades/tape, ticker, L2 books, order destinations](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-venue-during-opening-times.yml?branch=main&event=workflow_dispatch&label=quotations%2C%20price-for-order%2C%20market%20subscriptions%2C%20last%20trades%2Ftape%2C%20ticker%2C%20L2%20books%2C%20order%20destinations)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-venue-during-opening-times.yml)
[![watchlists, price alerts](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-reversible-account-mutations.yml?branch=main&event=workflow_dispatch&label=watchlists%2C%20price%20alerts)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-reversible-account-mutations.yml)
[![EUR 1 limit buy, exchangeClosed response](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-closed-venue-limit-order-rejection.yml?branch=main&event=workflow_dispatch&label=EUR%201%20limit%20buy%2C%20exchangeClosed%20response)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-closed-venue-limit-order-rejection.yml)
[![EUR 1 market buy, exchangeClosed response](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-closed-venue-market-order-rejection.yml?branch=main&event=workflow_dispatch&label=EUR%201%20market%20buy%2C%20exchangeClosed%20response)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-closed-venue-market-order-rejection.yml)
[![order updates, EUR 1 submit, EUR 0.50 replace, cancel, cleanup](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-open-venue-limit-order-lifecycle.yml?branch=main&event=workflow_dispatch&label=order%20updates%2C%20EUR%201%20submit%2C%20EUR%200.50%20replace%2C%20cancel%2C%20cleanup)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-open-venue-limit-order-lifecycle.yml)
[![manual custom ISIN, maximum EUR 5, automatic venue selection](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/execute-market-buy-on-live-account.yml?branch=main&event=workflow_dispatch&label=manual%20custom%20ISIN%2C%20maximum%20EUR%205%2C%20automatic%20venue%20selection)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/execute-market-buy-on-live-account.yml)

**Latest result (manually/scheduled)**

[![sessions, account, assets, derivatives, candles, orders, portfolio, timeline, documents, taxes, payments](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/general-read-only-validation.yml?branch=main&label=sessions%2C%20account%2C%20assets%2C%20derivatives%2C%20candles%2C%20orders%2C%20portfolio%2C%20timeline%2C%20documents%2C%20taxes%2C%20payments)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/general-read-only-validation.yml)
[![stocks, ETFs, funds, mutual funds, private funds, derivatives, crypto, bonds, synthetics](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-order-destinations-during-closed-market-hours.yml?branch=main&label=stocks%2C%20ETFs%2C%20funds%2C%20mutual%20funds%2C%20private%20funds%2C%20derivatives%2C%20crypto%2C%20bonds%2C%20synthetics)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-order-destinations-during-closed-market-hours.yml)
[![quotations, price-for-order, market subscriptions, last trades/tape, ticker, L2 books, order destinations](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-venue-during-opening-times.yml?branch=main&label=quotations%2C%20price-for-order%2C%20market%20subscriptions%2C%20last%20trades%2Ftape%2C%20ticker%2C%20L2%20books%2C%20order%20destinations)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-venue-during-opening-times.yml)
[![watchlists, price alerts](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-reversible-account-mutations.yml?branch=main&label=watchlists%2C%20price%20alerts)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-reversible-account-mutations.yml)
[![EUR 1 limit buy, exchangeClosed response](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-closed-venue-limit-order-rejection.yml?branch=main&label=EUR%201%20limit%20buy%2C%20exchangeClosed%20response)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-closed-venue-limit-order-rejection.yml)
[![EUR 1 market buy, exchangeClosed response](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-closed-venue-market-order-rejection.yml?branch=main&label=EUR%201%20market%20buy%2C%20exchangeClosed%20response)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-closed-venue-market-order-rejection.yml)
[![order updates, EUR 1 submit, EUR 0.50 replace, cancel, cleanup](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/validate-open-venue-limit-order-lifecycle.yml?branch=main&label=order%20updates%2C%20EUR%201%20submit%2C%20EUR%200.50%20replace%2C%20cancel%2C%20cleanup)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/validate-open-venue-limit-order-lifecycle.yml)
[![manual custom ISIN, maximum EUR 5, automatic venue selection](https://img.shields.io/github/actions/workflow/status/VIEWVIEWVIEW/handelsrepublik/execute-market-buy-on-live-account.yml?branch=main&label=manual%20custom%20ISIN%2C%20maximum%20EUR%205%2C%20automatic%20venue%20selection)](https://github.com/VIEWVIEWVIEW/handelsrepublik/actions/workflows/execute-market-buy-on-live-account.yml)
